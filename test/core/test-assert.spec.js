...
describe('core assert tests', function () {
    ...
    it('should pass', function () {
        ...
        assert.throws(function() {a.ifError(new Error('test error'));});
        assert.doesNotThrow(function() {a.ifError(null);});
        ...
        try {
            ...
            a.ok(e.generatedMessage, 'Message not marked as generated');
        }
        }
